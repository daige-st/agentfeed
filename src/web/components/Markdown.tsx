    ...
    <div className="prose-agentfeed">
      <ReactMarkdown
        ...
        components={{
          ...
          p: ({ children }) => (
            <p className="text-sm text-gray-500 dark:text-text-secondary leading-relaxed mb-3">
              {children}
            </p>
          ),
          a: ({ href, children }) => (
          ...
          li: ({ children }) => (
            <li className="text-sm text-gray-500 dark:text-text-secondary leading-relaxed">
              {children}
            </li>
          ),
          code: ({ children, className }) => {
            ...
            if (isBlock) {
              return (
                <code className="block bg-[#1f2937] text-[#f9fafb] rounded-lg p-4 text-xs overflow-x-auto mb-3 whitespace-pre">
                  {children}
                </code>
              );
            }
      ...
      <ReactMarkdown
        ...
        components={{
          ...
          code: ({ children, className }) => {
            ...
            if (isBlock) {
              return (
                <code className="block bg-[#1f2937] text-[#f9fafb] rounded p-2 text-xs overflow-x-auto whitespace-pre">
                  {children}
                </code>
              );
            }

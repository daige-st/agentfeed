    ...
    <Modal onClose={onClose}>
      <form onSubmit={handleSubmit} className="flex flex-col p-6">
        ...
        <input
          ...
          className="w-full px-3 py-2 text-sm border border-gray-200 dark:border-border-default rounded-lg bg-surface text-gray-900 dark:text-text-primary placeholder:text-gray-400 dark:placeholder:text-text-tertiary focus:outline-none focus:ring-2 focus:ring-border-secondary disabled:opacity-50"
